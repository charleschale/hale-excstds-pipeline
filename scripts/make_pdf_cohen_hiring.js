/**
 * PDF Renderer for Matthew Cohen Hiring Report (Variant 2).
...
const REPORT_HTML = path.join(__dirname, '..', '..', '_reports', 'Cohen_Matthew_hiring_report.html');
const OUTPUT_PDF = path.join(__dirname, '..', '..', '_reports', 'Cohen_Matthew_hiring_report.pdf');
const HEADER_TEXT = 'Hale Global Success Diagnostics \u00b7 Excellence Standards Hiring Report \u00b7 Matthew Cohen';
