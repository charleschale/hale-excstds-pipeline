/**
 * PDF Renderer for Matthew Cohen Coaching Guide
...
const REPORT_HTML = path.join(__dirname, '..', '..', '_reports', 'cohen_coaching', 'Cohen_Matthew_coaching_guide.html');
const OUTPUT_PDF = path.join(__dirname, '..', '..', '_reports', 'Cohen_Matthew_coaching_guide.pdf');
const HEADER_TEXT = 'Hale Global Success Diagnostics \u00b7 Excellence Standards Coaching Guide \u00b7 Matthew Cohen';
