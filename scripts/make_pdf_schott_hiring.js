/**
 * PDF Renderer for Timothy Schott Hiring Report (Variant 2).
 * Renders the HTML to PDF at 11x17 Tabloid (Meyrath-standard format).
 */
...
const REPORT_HTML = path.join(__dirname, '..', '..', '_reports', 'Schott_Timothy_hiring_report.html');
const OUTPUT_PDF = path.join(__dirname, '..', '..', '_reports', 'Schott_Timothy_hiring_report.pdf');
const HEADER_TEXT = 'Hale Global Success Diagnostics \u00b7 Excellence Standards Hiring Report \u00b7 Timothy Schott';
